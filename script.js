const week1Questions = [
  {section:"Phonics",tag:"SOUND CHECK",icon:"🏀",q:"What is the sound of the letter M?",hint:"Listen to a sound to unlock its answer button.",choices:["Phoneme M","Phoneme N"],audioChoices:["assets/audio/phonics/phoneme-m.mp3","assets/audio/phonics/phoneme-n.mp3"],choiceImagePaths:["assets/questions/letter-choices/week-1-gerry-M.webp","assets/questions/letter-choices/week-1-penny-N.webp"],choiceImageAlts:["Gerry holding a large yellow uppercase M","Penny holding a large purple uppercase N"],practice:"The sound of M is",practiceDisplay:"The sound of M is /m/.",answer:0},
...
const week2Questions = [
  {section:"Phonics",tag:"SOUND CHECK",icon:"🏀",q:"What is the sound of the letter M?",hint:"Listen to a sound to unlock its answer button.",choices:["Phoneme M","Phoneme N"],audioChoices:["assets/audio/phonics/phoneme-m.mp3","assets/audio/phonics/phoneme-n.mp3"],choiceImagePaths:["assets/questions/letter-choices/week-2-penny-m.webp","assets/questions/letter-choices/week-2-gerry-n.webp"],choiceImageAlts:["Penny holding a large yellow lowercase m","Gerry holding a large purple lowercase n"],practice:"The sound of M is",practiceDisplay:"The sound of M is /m/.",answer:0},
...
const week4Questions = [
  {section:"Phonics",tag:"SOUND CHECK",icon:"🔤",q:"What is the sound of the letter N?",hint:"Listen to a sound to unlock its answer button.",choices:["Phoneme N","Phoneme M"],audioChoices:["assets/audio/phonics/phoneme-n.mp3","assets/audio/phonics/phoneme-m.mp3"],choiceImagePaths:["assets/questions/letter-choices/week-4-ria-n.webp","assets/questions/letter-choices/week-4-syd-m.webp"],choiceImageAlts:["Ria holding a large purple lowercase n","Syd holding a large yellow lowercase m"],practice:"The sound of N is",practiceDisplay:"The sound of N is /n/.",answer:0},
  ...
  {section:"Reading",tag:"SPORTS READING",icon:"🎾",q:"What sport is it?\nIt's tennis.",hint:"Choose the picture that shows tennis.",choices:["Tennis","Soccer"],spokenChoices:["Tennis","Soccer"],choiceImagePaths:["assets/questions/week-4/sport-tennis.webp","assets/questions/week-4/sport-soccer.webp"],choiceImageAlts:["A child playing tennis","A child playing soccer"],choiceImagesWide:true,hideChoiceLabels:true,practice:"It's tennis.",answer:0},
  {section:"Reading",tag:"SPORTS READING",icon:"🏀",q:"What sport is it?\nIt's basketball.",hint:"Choose the picture that shows basketball.",choices:["Basketball","Tennis"],spokenChoices:["Basketball","Tennis"],choiceImagePaths:["assets/questions/week-4/sport-basketball.webp","assets/questions/week-4/sport-tennis.webp"],choiceImageAlts:["A child playing basketball","A child playing tennis"],choiceImagesWide:true,hideChoiceLabels:true,practice:"It's basketball.",answer:0},
  {section:"Reading",tag:"SPORTS READING",icon:"⚽",q:"What sport is it?\nIt's soccer.",hint:"Choose the picture that shows soccer.",choices:["Soccer","Basketball"],spokenChoices:["Soccer","Basketball"],choiceImagePaths:["assets/questions/week-4/sport-soccer.webp","assets/questions/week-4/sport-basketball.webp"],choiceImageAlts:["A child playing soccer","A child playing basketball"],choiceImagesWide:true,hideChoiceLabels:true,practice:"It's soccer.",answer:0},
...
function renderQuestion(){
  ...
  $("choices").innerHTML="";(choiceOrders[current]||[0,1]).forEach((index,visualPosition)=>{
    ...
    if(item.audioChoices){
      ...
      if(item.choiceImagePaths){const image=document.createElement("img");image.className="choice-picture sound-choice-picture";image.src=item.choiceImagePaths[index];image.alt=item.choiceImageAlts?.[index]||"";answerButton.appendChild(image)}
